...
SCHEMA_VERSIONS = {
    ...
    12: {
        "description": "更新任务表：增加自引用的父任务外键",
        "changes": {
            "new_tables": [],
            "alter_tables": {
                "task": {
                    "add_foreign_keys": {"parent_task_id": "task(task_id)"},
                }
            },
            "drop_tables": [],
        },
        "schema": {
            ...
            "task": {
                ...
                "foreign_keys": {"parent_task_id": "task(task_id)"},
                "indexes": ["name", "status", "created_at"],
                "db_name": "task",
            },
        },
    ...
    13: {
        "description": "更新交易记录表：移除对基金表的外键",
        "changes": {
            "new_tables": [],
            "alter_tables": {
                "fund_transaction": {
                    "drop_foreign_keys": ["fund_code"],
                }
            },
            "drop_tables": [],
        },
        "schema": {
            ...
            "fund_transaction": {
                ...
                "foreign_keys": {"portfolio_id": "portfolio(id)"},
                "indexes": ["portfolio_id", "fund_code"],
                "db_name": "main",
            },
            "fund_positions": {
